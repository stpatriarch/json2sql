...
def parser():
    ...
    sqlite_parser.add_argument('--input', '-i', required=True, help='json ֆայլի ճանապարհ | json file path')
    ...
    postgres_parser.add_argument('--input', '-i', required=True, help='json ֆայլի ճանապարհ | json file path')
    ...
    mysql_parser.add_argument('--input', '-i', required=True, help='json ֆայլի ճանապարհ | json file path')
    ...
    mysql_parser.add_argument("--password", default="mysql_95", help="Բազզայի գաղտնաբառը | base password")
