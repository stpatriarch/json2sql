...
Մոդուլի այս հատվածը իրենից ներկայացնում է պահոց երկու բառարանների համար.

**SQL_TYPES** - այստեղ պահված են sql-json համադրված, համարժեք տվյալների տեսակները ըստ sql շարժիչների։

**PLACEHOLDERS** - այստեղ պահված են տեղապահ սիմվոլները ըստ sql շարժիչների։
...
Մոդուլը տալիս է ցուցմունքներ յուաքանչյուր շարժիչին համապատսխան, համադրել տվյալների տեսակները json-sql դրանք հաջողությամբ գրանցելու համար ՏԲ։
...
**`SqlEngineAcceptType` &emsp; | &emsp; ՇԱՐԺԻՉՆԵՐԻ ՏՎՅԱԼՆԵՐԻ ՏԵՍԱԿՆԵՐԻ ՈՐՈՇԻՉ**

params: engine: str

Դասը ստուգում է շարժիչի տեսակը, եթե այն թույլատրելի է, այսինքն առկա է աջակցվող շարժիչների ցուցակում ապա այն իր ֆունկցիայի օգնությամբ կտրամադրի համապտասխան տվյալների տեսակները առաջնորդվելով ստացված ջեյսոն-տվյալի օրինակի։

<br>

_SqlEngineAcceptType_.**`define_types(json: dict, ident: str) -> dict:` &emsp; | &emsp; ՏՎՅԱԼՆԵՐԻ ՓՈԽԱԴՐԻՉ**

params: json: dict, ident: str

returns: dict

Ֆունկցիան ստոգում է ջեյսոնի պայմանական տիպը, վերձնում ձևանմուշ, դրա և արդեն իդենտիֆիկացված շարժիչի հիման վրա ստանում վերոհիշյալ **sql_data_mapping** պահոցից հադրյալ տվյալների տեսակները և գրանցում դրանք նոր բառարում վերադրաձնելով այն։
...
**Command line interface փարսեր, սխալների բռնիչների հավաքական մոդուլ։**
...
Սա սխալների բռնիչ-միքսինների հավաքածու է։
...
**`FileError -> EngineError -> NotSupportedMixin` &emsp; | &emsp; ԲՌՆԻՉՆԵՐ**

Այս երեքը նախատեսված են սպեցեֆիկ ֆայլի կամ տվյալներ որսալու համար, առաջին երկուսը օգնականի դեր են կատարում երրոդի համար, վերջինսկատարում է մոդուլի հիմանակն լոգիկան։

<br>

_NotSupportedMixin_.**`unsupported_type(self, type) -> None` &emsp; | &emsp; ՏԻՊԻ ԲՌՆԻՉ**

params: type: Str

returns: Exeption

Եթե ջեյսոնի պայմանական տիպը չկա աջակցվողների ցուցակում կանչվում է այս ֆունկցիան, այն նաև կցուցադրի չաջակցվող տիպի պայմանական անունը։

<br>

_NotSupportedMixin_.**`unsupported_engine(self, engine)` &emsp; | &emsp; ՇԱՐԺԻՉԻ ԲՌՆԻՉ**

params: engine: Str

returns: Exeption

Եթե շարժիչի տեսակը չկա առակցվողների ցուցակում կանչվում է այս ֆունկցիան, ակն նաև կցուցադրի չաջակցվող շարժիչի անվանումը։
...
Command line interface-ի փարսեր։
...
**`is_json(file: str) -> str` &emsp; | &emsp; ՋԵՅՍՈՆ ՖԱՅԼԻ ՍՏՈՒԳԻՉ**

params: file: Str

returns: Str

Ֆունկցիան միագամից ստուգում է արդյոք տրված պարանետրում փոխանցված ֆայլը json ֆորմատի է թե ոչ։

<br>

**`parser(void)` &emsp; | &emsp; ԻՆՏԵՐՖԵՅՍԻ ՓԱՐՍԵՐ**

params: None

returns: ArgumentParser object

Ֆունկցիան կատարում է CLI ինտերֆեյսի ամբողջ լոգիկան, տրամադրելով հարմար ինտեֆեյս աշխատելու գործիքի հետ և որսում սխալները, անթույլատրելի կամ բացակա պարամետրերը։
